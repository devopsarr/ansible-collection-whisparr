...
DOCUMENTATION = r'''
---
module: whisparr_remote_path_mapping

short_description: Manages Whisparr remote path mapping.

version_added: "0.0.1"

description: Manages Whisparr remote path mapping.
...
- name: Create a remote path mapping
  devopsarr.whisparr.remote_path_mapping:
...
def run_module():
    ...
    client = whisparr.RemotePathMappingApi(module.api)
    ...
    want = whisparr.RemotePathMappingResource(**{
