...
DOCUMENTATION = r'''
---
module: whisparr_system_info

short_description: Whisparr system info module

version_added: "0.0.1"

description: Provide Whisparr system info
...
- name: Test with a message
  devopsarr.whisparr.whisparr_system_info:
'''

RETURN = r'''
# These are examples of possible return values, and in general should use other names for return values.
app_name:
    description: It should be Whisparr.
    type: str
    returned: always
    sample: 'Whisparr'
version:
...
def run_module():
    ...
    client = whisparr.SystemApi(module.api)
